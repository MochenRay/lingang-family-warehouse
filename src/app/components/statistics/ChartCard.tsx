...
export function ChartCard({ 
  ...
  return (
    <Card
      className={cn(
        "gap-4 rounded-[4px] border border-[var(--color-neutral-03)] bg-[var(--color-neutral-02)] text-[var(--color-neutral-10)] shadow-none hover:shadow-02",
        className
      )}
    >
          ...
          <div className="flex items-center gap-2">
            ...
            {info && (
              <Tooltip>
                ...
                <TooltipContent className="border border-[var(--color-neutral-03)] bg-[var(--color-neutral-01)] text-[var(--color-neutral-10)] shadow-02">
      ...
      <CardContent className="px-5 pb-5">
        {loading ? (
          <Skeleton className="h-[300px] w-full" aria-label="图表加载中" />
        ) : (
          children
        )}
      </CardContent>
