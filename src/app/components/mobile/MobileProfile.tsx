          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full border border-[var(--color-brand-primary)]/30 flex items-center justify-center shadow-lg shadow-blue-900/20 bg-[var(--color-brand-primary)]/10">
                <User className="w-7 h-7 text-[var(--color-brand-text)]" />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <div className="text-[var(--color-neutral-11)] font-bold text-xl tracking-wide">{username}</div>
                  <div className="px-1.5 py-0.5 bg-[var(--color-neutral-03)] rounded text-xs text-[var(--color-neutral-10)] border border-[var(--color-neutral-04)]">网格员</div>
                </div>
            ...
            <CardContent className="p-5">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-5 h-5 flex items-center justify-center">
                  <Award className="w-5 h-5 text-[var(--color-brand-text)]" />
                </div>
                <span className="font-bold text-[var(--color-neutral-11)] text-sm">本月工作概览</span>
                <div className="ml-auto flex items-center gap-1 px-2 py-0.5 bg-[var(--color-neutral-03)] rounded-full text-xs text-[var(--color-neutral-10)] cursor-pointer">
              ...
              <div className="grid grid-cols-4 gap-3">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-[var(--color-status-success-text)] mb-1">{stats.monthTasks}</div>
                  <div className="text-xs text-[var(--color-neutral-08)] font-medium">完成任务</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[var(--color-status-warning-text)] mb-1">{stats.monthReports}</div>
