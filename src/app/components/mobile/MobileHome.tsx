...
export function MobileHome({ onRouteChange, onExitMobile }: MobileHomeProps) {
  ...
  const quickActions = [
    ...
    },
    {
      icon: Building2,
      label: '房屋台账',
      color: 'bg-[var(--color-brand-primary-hover)]',
      path: 'housing',
      desc: '查看房屋与居住关系'
    },
    {
  ...
  return (
    <MobileLayout currentRoute="home" onRouteChange={onRouteChange} onExitMobile={onExitMobile}>
      ...
      <div className="relative bg-gradient-to-br from-[var(--color-neutral-00)] via-[var(--color-neutral-01)] to-[var(--color-neutral-02)] px-4 pt-2 pb-4 border-b border-[var(--color-neutral-03)]">
        ...
        <div className="relative z-10 flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <div className="w-14 h-14 bg-gradient-to-br from-[var(--color-brand-primary)] to-[var(--color-brand-primary-hover)] rounded-full flex items-center justify-center shadow-lg">
        ...
        >
          {/* 装饰性渐变 */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[var(--color-brand-primary)] to-transparent opacity-10 rounded-full blur-2xl"></div>
          
          <CardContent className="relative z-10 p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <div className="w-1.5 h-5 bg-gradient-to-b from-[var(--color-brand-primary)] to-[var(--color-brand-primary-hover)] rounded-full"></div>
      ...
      <div className="px-4 pt-2 pb-6">
        ...
        {showOnboarding && (
          <div className="absolute inset-0 z-[70] flex items-center justify-center bg-black/55 px-4 backdrop-blur-sm">
            <Card className="w-full max-w-[335px] overflow-hidden border-[var(--color-brand-primary)]/35 bg-[linear-gradient(135deg,var(--color-neutral-01),var(--color-neutral-02))] shadow-2xl">
